  ...
  setup() {
    ...
    return () => (
      <div class="w-full max-w-md mx-auto p-6 bg-white dark:bg-gray-800 rounded-xl shadow-md">
        ...
        <div class="space-y-4">
          <div>
            <label class="block text-sm font-medium mb-1">Password Length: {passwordLength.value}</label>
            <input 
              type="range" 
              min="4" 
              max="32" 
            ...
            <div class="mt-4">
              ...
              <div class="mb-2">
                <div class="w-full bg-gray-200 rounded-full h-2.5">
                  <div 
                    class={`h-2.5 rounded-full ${strengthColor.value}`} 
              ...
              <p class="text-sm text-gray-600">
                Password Strength: 
                {passwordStrength.value < 30 ? 'Weak' : 
                 passwordStrength.value < 60 ? 'Fair' : 
                 passwordStrength.value < 80 ? 'Good' : 'Strong'}
              </p>
            </div>
          )}
        </div>
